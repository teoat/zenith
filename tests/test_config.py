...
TEST_SQLCIPHER_KEY = (
    "test_sqlcipher_key_for_development_only_123456789012345678901234567890"
)

# Test authentication encryption key
TEST_AUTH_ENCRYPTION_KEY = (
    "test_auth_key_for_development_only_123456789012345678901234567890"
)
...
def get_test_db_config() -> dict[str, Any]:
    ...
    return {"SQLCIPHER_KEY": TEST_SQLCIPHER_KEY, "database_url": "./data/test_audit.db"}
