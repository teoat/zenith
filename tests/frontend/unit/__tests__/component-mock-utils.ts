...
jest.mock('react-grid-layout', () => ({
  ResponsiveGridLayout: ({ children, ...props }: any) => (
    React.createElement('div', { 'data-testid': 'grid-layout', ...props }, children)
  )
}));
...
jest.mock('react-force-graph-2d', () => ({
  ...
  default: React.forwardRef((props, ref) =>
    React.createElement('div', { ref, 'data-testid': 'force-graph', ...props }, 'Force Graph')
  )
}));
...
export const createComponentMocks = () => {
  ...
  jest.mock('../components/dashboard/ThreatMap', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'threat-map', ...props }, 'Threat Map')
  }));

  jest.mock('../components/dashboard/AIWatchtower', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'ai-watchtower', ...props }, 'AI Watchtower')
  }));

  jest.mock('../components/dashboard/LiveQueue', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'live-queue', ...props }, 'Live Queue')
  }));

  jest.mock('../components/dashboard/VolumeChart', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'volume-chart', ...props }, 'Volume Chart')
  }));

  jest.mock('../components/dashboard/RiskDistributionChart', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'risk-chart', ...props }, 'Risk Chart')
  }));

  jest.mock('../components/dashboard/ProofVisualizationCard', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'proof-viz', ...props }, 'Proof Visualization')
  }));

  jest.mock('../components/dashboard/CostOptimizationWidget', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'cost-widget', ...props }, 'Cost Widget')
  }));

  // Mock other components
  jest.mock('../components/common/RookieChecklist', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'rookie-checklist', ...props }, 'Rookie Checklist')
  }));

  jest.mock('../components/common/WelcomeMessage', () => ({
    __esModule: true,
    default: (props: any) => React.createElement('div', { 'data-testid': 'welcome-message', ...props }, 'Welcome Message')
  }));
