...
class TestAuthMFA:
    ...
    def test_mfa_verify_valid_code(self, client, auth_headers):
        ...
        # Verify
        response = client.post(
            "/api/v1/auth/mfa/verify", headers=auth_headers, json={"code": valid_code}
        )
    ...
    def test_mfa_verify_invalid_code_fails(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/auth/mfa/verify", headers=auth_headers, json={"code": "000000"}
        )
...
class TestAuthTokenRefresh:
    ...
    def test_refresh_token_success(self, client):
        ...
        login_response = client.post(
            "/api/v1/auth/login",
            json={"username": "refreshtest", "password": "RefreshPass123!"},
        )
    ...
    def test_refresh_with_invalid_token_fails(self, client):
        ...
        response = client.post(
            "/api/v1/auth/refresh", json={"refresh_token": "invalid_token_12345"}
        )
...
class TestAuthAuthorization:
    ...
    def test_admin_can_access_admin_endpoint(self, client):
        ...
        response = client.get(
            "/api/v1/admin/database/stats", headers={"Authorization": f"Bearer {token}"}
        )
    ...
    def test_manager_role_permissions(self, client):
        ...
        response = client.get(
            "/api/v1/cases/manage", headers={"Authorization": f"Bearer {token}"}
        )
...
class TestAuthSecurity:
    ...
    def test_sql_injection_protection(self, client):
        ...
        response = client.post(
            "/api/v1/auth/login",
            json={"username": "admin' OR '1'='1", "password": "password' OR '1'='1"},
        )
    ...
    def test_token_expiration(self, client):
        ...
        expired_token = (
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1MTYyMzkwMjJ9.invalid"
        )
