...
class TestCaseService:
    ...
    def test_create_case(self):
        ...
        # Verify db.add and commit were called
    ...
    def test_update_case(self, mock_session):
        ...
        # Mock query chain: query.options().filter().first()
        mock_query = Mock()
        mock_filter_query = Mock()

        mock_query.options.return_value = mock_filter_query
        mock_filter_query.filter.return_value = mock_filter_query
        mock_filter_query.first.return_value = mock_case
