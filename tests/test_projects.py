...
class TestProjectManagement:
    ...
    def test_create_project(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/projects", headers=auth_headers, json=project_data
        )
    ...
    def test_get_project_by_id(self, client, auth_headers):
        ...
        create_res = client.post(
            "/api/v1/projects", headers=auth_headers, json={"name": "Lookup Project"}
        )
    ...
    def test_get_project_not_found(self, client, auth_headers):
        ...
        response = client.get(
            "/api/v1/projects/non_existent_id_999", headers=auth_headers
        )
