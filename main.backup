...
async def http_exception_handler(request: Request, exc: HTTPException):
    """Handle HTTP exceptions with structured logging and standardized response"""
    log_error(
        "http_exception",
...
async def general_exception_handler(request: Request, exc: Exception):
    """Handle unexpected exceptions with structured logging and standardized response"""
    error_details = {
