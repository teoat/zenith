...
class TestMultiModalAnalyzer:
    ...
    def test_analyze_image_file(self, analyzer, temp_image_file):
        ...
        result = analyzer.analyze_evidence(temp_image_file, options={'enable_ocr': False})
    ...
    def test_image_forensics_trigger(self, analyzer, temp_image_file):
        ...
        result = analyzer.analyze_evidence(temp_image_file, options={'enable_forensics': True})
    ...
    def test_unsupported_file_type(self, analyzer, tmp_path):
        ...
        assert "Unsupported" in result.errors[0] or "analysis failed" in result.errors[0]
