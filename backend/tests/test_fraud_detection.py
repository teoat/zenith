...
class TestFraudDetectionEngine:
    ...
    def test_structuring_detection_positive(self, detection_engine):
        ...
        transactions = [
            Transaction(
                "tx1", 9900, now - timedelta(hours=2), "ACC001", "ACC002", "Payment 1"
            ),
            Transaction(
                "tx2", 9800, now - timedelta(hours=1), "ACC001", "ACC002", "Payment 2"
            ),
    ...
    def test_structuring_detection_negative(self, detection_engine):
        ...
        transactions = [
            Transaction(
                "tx1", 5000, now - timedelta(hours=48), "ACC001", "ACC002", "Payment 1"
            ),
            Transaction(
                "tx2", 3000, now - timedelta(hours=24), "ACC001", "ACC002", "Payment 2"
            ),
    ...
    def test_round_trip_detection_positive(self, detection_engine):
        ...
        transactions = [
            Transaction(
                "rtx1", 5000, now - timedelta(hours=48), "ACC004", "ACC005", "Transfer"
            ),
            Transaction(
                "rtx2", 4800, now - timedelta(hours=24), "ACC005", "ACC006", "Payment"
            ),
    ...
    def test_round_trip_detection_negative(self, detection_engine):
        ...
        transactions = [
            Transaction(
                "tx1", 5000, now - timedelta(hours=48), "ACC004", "ACC005", "Transfer"
            ),
            Transaction(
                "tx2", 4800, now - timedelta(hours=24), "ACC005", "ACC006", "Payment"
            ),
    ...
    def test_mixed_fraud_types(self, detection_engine):
        ...
        transactions = [
            ...
            *[
            ...
            # Round trip
            Transaction(
                "r1", 5000, now - timedelta(hours=48), "ACC004", "ACC005", "Transfer"
            ),
            Transaction(
                "r2", 4800, now - timedelta(hours=24), "ACC005", "ACC006", "Payment"
            ),
