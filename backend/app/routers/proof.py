...
from app.services.temporal_burst_detector import TemporalBurstDetector, temporal_burst_detector
from app.services.immutable_audit_chain import ImmutableAuditChainService, immutable_audit_chain
...
for _svc in ('relationship_graph', 'metadata_correlation_engine', 'immutable_audit_chain'):
...
def get_proof_summary(
    ...
    try:
        ...
        try:
            ...
            metadata_summary = {"total_correlations": 0, "types": {}, "confidence": 0, "error": str(e)}
        ...
        try:
            ...
            burst_summary = {
                ...
                "confidence": min(1.0, burst_results.get('summary', {}).get('overall_risk_score', 0) / 100)
            }
        except Exception as e:
            logger.warning(f"Temporal burst detection failed: {e}")
            burst_summary = {"alerts": 0, "risk_score": 0, "patterns": {}, "confidence": 0, "error": str(e)}
        ...
        try:
            ...
            audit_summary = {"status": "error", "total_entries": 0, "integrity_percentage": 0, "confidence": 0, "error": str(e)}
        ...
        try:
            ...
            shell_summary = {"networks_detected": 0, "highest_risk_score": 0, "confidence": 0, "error": str(e)}
