    ...
    try:
        ...
        try:
            ...
            result = {
                ...
                "forensic_analysis": {
                    "manipulation_score": analysis.forensic_result.manipulation_score if analysis.forensic_result else 0.0,
                    "authenticity_score": analysis.forensic_result.authenticity_score if analysis.forensic_result else 50.0,
                    "forensic_indicators": analysis.forensic_result.forensic_indicators if analysis.forensic_result else [],
                    "metadata_analysis": analysis.forensic_result.metadata_analysis if analysis.forensic_result else {},
                    "confidence": analysis.forensic_result.confidence if analysis.forensic_result else 0.0
                },
                "quality_assessment": {
    ...
    try:
        capabilities = {
            ...
            "supported_file_types": {
                "images": ["image/jpeg", "image/png", "image/tiff", "image/bmp", "image/gif", "image/webp"],
                "documents": [
                    "application/pdf",
                    "application/msword",
...
async def get_analysis_status():
    ...
    try:
        status = {
            ...
            "modules": {
                "ocr": "available" if multimodal_analyzer.ocr_available else "unavailable",
                "image_analysis": "available" if multimodal_analyzer.image_analysis_available else "unavailable",
                "document_analysis": "available" if multimodal_analyzer.document_analysis_available else "unavailable",
                "forensic_analysis": "available" if multimodal_analyzer.forensic_available else "unavailable"
            },
