...
from app.services.logging_service import get_logger, LogLevel, LogCategory
...
async def log_user_action(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to log user action: {str(e)}")
...
async def log_api_request(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to log API request: {str(e)}")
...
async def log_performance_metric(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to log performance metric: {str(e)}")
...
async def test_pii_scrubbing(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to test PII scrubbing: {str(e)}")
