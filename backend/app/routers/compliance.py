...
async def create_regulatory_report(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to create regulatory report")
...
async def submit_security_incident(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to submit security incident")
...
async def record_training_completion(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to record training completion")
...
async def get_data_residency_rules(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to get data residency rules")
...
async def update_regional_compliance(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to update regional compliance")
...
async def get_audit_logs(
    ...
    try:
        ...
        logs = db.query(ComplianceAuditLog).order_by(
