...
from app.services.sync_service import sync_manager, CRDTDocument
    ...
    try:
        ...
        while True:
            try:
                ...
                await sync_manager._send_to_client(client_id, {
                    "type": "error",
    ...
    try:
        ...
        state.update({
            "subscribers_count": sum(
                1 for subs in sync_manager.client_subscriptions.values() 
