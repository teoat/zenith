...
from app.services.notification_service import notification_system, NotificationType, NotificationPriority, NotificationChannel
...
async def trigger_notification(
    ...
    try:
        ...
        background_tasks.add_task(
            notification_system.process_event,
            event_type,
            data,
            recipient
        )
...
async def test_notification(
    ...
    try:
        ...
        data = test_data.get(notification_type, {
            "test": True,
