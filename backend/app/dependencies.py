...
async def get_current_project_id(x_project_id: Optional[str] = Header(None, alias="X-Project-ID")) -> str:
    """
...
async def require_project_id(x_project_id: Optional[str] = Header(None, alias="X-Project-ID")) -> str:
    """
