    ...
    def __init__(self):
        self.case_templates = {
            "aml_investigation": {
                ...
                "events": ["Initial Alert", "Transaction Analysis", "Pattern Detection", "SAR Filing"]
            },
            "fraud_detection": {
                "title": "Fraud Detection Timeline", 
                "events": ["Alert Triggered", "Evidence Collection", "Risk Assessment", "Investigation Findings"]
            },
            "network_analysis": {
                "title": "Network Analysis Timeline",
                "events": ["Entity Mapping", "Relationship Discovery", "Transaction Flow Analysis", "Network Disruption"]
            }
        }
        ...
        try:
            ...
            for tx in transaction_data:
                event = TimelineEvent(
                    ...
                    metadata={"amount": tx.get("amount"), "risk_score": tx.get("risk_score")}
                )
                events.append(event)
