    ...
    def check_thresholds(self) -> List[str]:
        ...
        for metric, threshold in thresholds.items():
            if current.get(metric, 0) > threshold:
                ...
                self._generate_alert(f"high_{metric.replace('_percent', '').replace('_usage', '_usage')}",
    ...
    async def perform_root_cause_analysis(self, incident_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if incident_data.get('type') == 'performance_degradation':
            analysis.update({
                ...
                'contributing_factors': ['high_cpu_usage', 'memory_pressure', 'database_contention'],
            ...
            analysis.update({
                ...
                'contributing_factors': ['external_service_down', 'network_issues', 'configuration_error'],
