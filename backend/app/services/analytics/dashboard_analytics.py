...
class AnalyticsDashboard:
    ...
    def __init__(self):
        ...
        self.configuration = DashboardConfiguration(
            time_range=30,
            auto_refresh=True,
            displayed_metrics=["total_cases", "success_rate", "ai_assist_rate", "fraud_detection_rate"],
            alert_thresholds={
    ...
    def _setup_initial_data(self):
        ...
        for i in range(30):
            ...
            self.metrics_history.append(PerformanceTrend(
                date=date,
    ...
    async def get_performance_trends(self, time_range_days: int = 30) -> List[PerformanceTrend]:
        ...
        try:
            ...
            recent_trends = [
                trend for trend in self.metrics_history 
