...
class SemanticSearchEngine:
    ...
    def _init_faiss_backend(self):
        ...
        try:
            ...
            self.faiss_metadata_path = self.config.get('metadata_path', './data/faiss_metadata.pkl')
    ...
    def index_document(self, document_id: str, content: str, 
                    metadata: Dict[str, Any] = None) -> IndexingResult:
        """
    ...
    def _index_document_chroma(self, document_id: str, content: str, 
                             metadata: Dict[str, Any], start_time: datetime) -> IndexingResult:
    ...
    def _index_document_faiss(self, document_id: str, content: str, 
                           metadata: Dict[str, Any], start_time: datetime) -> IndexingResult:
    ...
    def search(self, query: str, limit: int = 10, 
               threshold: float = 0.0, filters: Dict[str, Any] = None) -> List[SearchResult]:
        """
    ...
    def _search_chroma(self, query: str, limit: int, threshold: float, 
