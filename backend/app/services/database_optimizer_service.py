...
from core.database import SessionLocal, Case, Transaction, Evidence, CaseNote, CaseActivity
...
class DatabaseOptimizer:
    ...
    def get_paginated_cases(self, page: int = 1, per_page: int = 20, filters: Dict[str, Any] = None) -> Dict[str, Any]:
    ...
    def get_case_with_optimized_relationships(self, case_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_optimized_transaction_aggregates(self, case_id: str = None, date_from=None, date_to=None) -> Dict[str, Any]:
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_query_time': sum(m['execution_time'] for m in self.performance_metrics) / len(self.performance_metrics) if self.performance_metrics else 0,
    ...
    def get_database_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in table_stats:
                table_name = row.name
                count_result = self.execute_optimized_query(f"SELECT COUNT(*) as count FROM {table_name};")
