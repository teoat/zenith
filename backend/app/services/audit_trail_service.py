...
class AuditTrailService:
    ...
    async def log_event(self, event_type: AuditEventType,
        ...
        logger.log(log_level, f"AUDIT: {event_id} - {user_id or 'system'} {action} on {resource}")
    ...
    def _determine_severity(self, event_type: AuditEventType,
                           resource: str, action: str) -> AuditSeverity:
        """
    ...
    async def get_compliance_report(self) -> Dict[str, Any]:
        ...
        compliance_metrics = {
            ...
            'data_modification_events': len([e for e in recent_events
            ...
            'admin_operations': len([e for e in recent_events
        ...
        required_coverage = ['authentication', 'data_modification', 'security_events', 'admin_operations']
        coverage_scores = []

        for required in required_coverage:
            if required in ['authentication']:
                # Check login/logout events
                auth_events = len([e for e in recent_events
