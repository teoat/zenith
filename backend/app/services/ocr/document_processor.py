...
class DocumentProcessor:
    ...
    def _extract_entities(self, text: str) -> List[Dict[str, Any]]:
        ...
        for amount in amounts:
            entities.append({"type": "amount", "value": amount, "confidence": 0.95})

        # Extract dates
        dates = re.findall(r"\d{4}-\d{2}-\d{2}", text)
        for date in dates:
            entities.append({"type": "date", "value": date, "confidence": 0.98})
        ...
        for email in emails:
            entities.append({"type": "email", "value": email, "confidence": 0.99})
...
class ReceiptProcessor:
    ...
    async def process_receipt(self, file_data: bytes, filename: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "totals": {"subtotal": 123.45, "tax": 0.00, "total": 123.45},
            "payment": {"method": "Credit Card", "last_four": "1234"},
            "confidence": 0.89,
        }
...
class InvoiceProcessor:
    ...
    async def process_invoice(self, file_data: bytes, filename: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "client": {"name": "Client Inc", "address": "789 Customer Blvd"},
            "dates": {"invoice_date": "2025-12-01", "due_date": "2025-12-31"},
            "line_items": [
                {
            ...
            "totals": {"subtotal": 2000.00, "tax": 160.00, "total": 2160.00},
