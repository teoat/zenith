...
class ExplainableFraudDetector:
    ...
    async def explain_prediction(self, transaction_data: Dict[str, Any],
                               prediction_result: Dict[str, Any]) -> PredictionExplanation:
        """
    ...
    async def _calculate_feature_contributions(self, transaction_data: Dict[str, Any],
                                            prediction_result: Dict[str, Any]) -> List[FeatureContribution]:
        ...
        feature_definitions = {
            ...
            'transaction_frequency': {'name': 'Transaction Frequency', 'importance': 0.8},
    ...
    async def _find_similar_cases(self, transaction_data: Dict[str, Any],
            ...
            similar_cases = [
                {
                    ...
                    'key_similarities': ['High amount', 'Unusual merchant', 'Geographic anomaly']
                },
                {
            ...
            similar_cases = [
                {
                    ...
                    'key_similarities': ['Amount slightly above average', 'Known merchant']
                }
            ]
        else:
    ...
    async def _generate_counterfactuals(self, transaction_data: Dict[str, Any],
                                     prediction_result: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _assess_risk_level(self, contributions: List[FeatureContribution],
                          prediction_result: Dict[str, Any]) -> Tuple[str, str]:
    ...
    def _calculate_explanation_confidence(self, contributions: List[FeatureContribution],
