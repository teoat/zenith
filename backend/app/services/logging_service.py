...
class PIIScrubber:
    ...
    def scrub_pii(text: str, mask_char: str = "***") -> str:
        ...
        patterns = [
            ...
            (PIIScrubber.CREDIT_CARD_PATTERN, f'{mask_char}-{mask_char}-{mask_char}-{mask_char}'),
            (PIIScrubber.IP_ADDRESS_PATTERN, f'{mask_char}.{mask_char}.{mask_char}.{mask_char}'),
...
class StructuredLogger:
    ...
    def _create_file_formatter(self) -> logging.Formatter:
        ...
        class StructuredFormatter(logging.Formatter):
            def format(self, record):
                ...
                for attr in ['user_id', 'session_id', 'request_id', 'category', 'metadata']:
    ...
    def _scrub_log_entry(self, log_entry: LogEntry) -> LogEntry:
        ...
        pii_fields_to_scrub = ['email', 'phone', 'ssn', 'credit_card', 'address', 'name']
