...
from core.immutable_audit import immutable_audit, ImmutableAuditLog
...
class ImmutableAuditChainService:
    ...
    def __init__(self, audit_log: Optional[ImmutableAuditLog] = None):
    ...
    def get_chain_stats(self) -> Dict[str, Any]:
        ...
        entity_types = list(set(e.get('entity_type', 'unknown') for e in self._entries))
