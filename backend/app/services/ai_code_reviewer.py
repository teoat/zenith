...
class AIPoweredCodeReviewer:
    ...
    async def analyze_codebase(self, codebase_path: str, file_patterns: List[str] = None,
                             exclude_patterns: List[str] = None) -> CodeReviewResult:
        """
    ...
    async def _discover_files(self, codebase_path: str, file_patterns: List[str] = None,
        ...
        if exclude_patterns is None:
            exclude_patterns = ['node_modules/**', '__pycache__/**', '*.min.js', 'dist/**', 'build/**']
    ...
    def _apply_language_rules(self, content: str, lines: List[str], file_path: str,
                            language: str) -> List[CodeIssue]:
    ...
    def _analyze_complexity(self, content: str, lines: List[str], file_path: str,
                          language: str) -> List[CodeIssue]:
        ...
        try:
            ...
            for node in ast.walk(tree):
                if isinstance(node, ast.FunctionDef):
                    ...
                    if complexity > self.quality_metrics['thresholds']['max_complexity']:
                        issues.append(CodeIssue(
                            file_path=file_path,
                            line_number=node.lineno,
                            column=None,
    ...
    def _calculate_quality_score(self, issues: List[CodeIssue], total_lines: int,
    ...
    def _generate_metrics(self, issues: List[CodeIssue], total_lines: int,
                        files_analyzed: int) -> Dict[str, Any]:
        ...
        for change in code_changes:
            ...
            if 'function' in code_diff.lower() or 'def ' in code_diff:
                suggestions.append(TestSuggestion(
                    ...
                    coverage_areas=["function_logic", "edge_cases", "error_handling"],
                    priority="high",
                    complexity="medium"
                ))
            ...
            if 'api' in code_diff.lower() or 'endpoint' in code_diff.lower():
                suggestions.append(TestSuggestion(
                    ...
                    coverage_areas=["http_methods", "status_codes", "data_validation"],
                    priority="high",
                    complexity="medium"
                ))
            ...
            if 'database' in code_diff.lower() or 'sql' in code_diff.lower():
                suggestions.append(TestSuggestion(
                    ...
                    coverage_areas=["data_integrity", "transaction_handling", "error_conditions"],
                    priority="medium",
                    complexity="high"
                ))
