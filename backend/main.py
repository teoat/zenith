...
from core.rate_limiting import RateLimitExceeded, RateLimitingMiddleware
...
# Security headers middleware (Already imported and added above)
...
app.include_router(compliance_router, prefix=f"/api/{API_VERSION}", tags=["Compliance"])
