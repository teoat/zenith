...
def upgrade() -> None:
    ...
    if 'metadata' in columns and 'activity_metadata' not in columns:
        ...
        # Recreate indexes
        op.create_index('idx_case_activity_case_timestamp', 'case_activities', ['case_id', 'timestamp'])
        op.create_index('idx_case_activity_type_timestamp', 'case_activities', ['activity_type', 'timestamp'])
        op.create_index('idx_case_activity_user_timestamp', 'case_activities', ['user_id', 'timestamp'])
