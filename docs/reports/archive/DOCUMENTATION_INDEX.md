...
- Enhanced getting started: [learn/getting-started/enhanced_quick_start.md](learn/getting-started/enhanced_quick_start.md)
...
### **What's New:**
- 👥 **[Users](learn/tutorials/admin-users.md)** - End-user guides and tutorials
...
- 📊 **[API](current/technical/api.md)** - Complete API documentation
- 🚀 **[Deployment](04_Operations_and_Deployment/deployment.md)** - DevOps and operations
- 📋 **[Project](archive/v1/PROJECT_OVERVIEW 2.md)** - Project management and planning
...
|---------|-------------|---------------|
| **Getting Started** | Platform introduction and basic usage | [Quick Start](users/getting-started.md), [FAQ](learn/faq.md) |
| **Core Workflows** | Main user workflows and processes | [Project Selection](users/project_selection.md), [Dashboard](archive/2025/q4/planning/dashboard.md), [Cases](archive/2025/q4/planning/cases.md), [Investigation](users/investigation.md) |
| **Specialized Tasks** | Evidence handling, reporting, settings | [Ingestion](users/ingestion.md), [Network Analysis](users/network-analysis.md), [Settings](archive/2025/q4/planning/settings.md) |
| **Interactive Tutorials** | Step-by-step walkthroughs | [First Case](archive/2025/q4/planning/first-case.md), [Fraud Analysis](archive/2025/q4/planning/fraud-analysis.md) |
...
| Section | Description | Key Documents |
|---------|-------------|---------------|
| **Planning & Roadmap** | Project vision and roadmap | [Roadmap](current/planning/roadmap.md) |
...
| **Diagnostics & Analysis** | Unified system analysis and reporting | [Consolidated System Status](reports/CONSOLIDATED_SYSTEM_STATUS_2025_12_16.md), [Diagnostic Reports Archive](operate/deployment/orchestration_plan_archived.md) |
...
- **Repository:** https://github.com/organization/Zenith
