...
DATABASE_URL=postgresql://378x492:password@localhost/378x492_dev
...
sudo -u postgres createdb 378x492_dev
sudo -u postgres createuser 378x492
sudo -u postgres psql -c "ALTER USER 378x492 PASSWORD 'password';"
sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE 378x492_dev TO 378x492;"
