...
*   **Processing Logic:** See [00_FRAUD_LOGIC.md](../00_ARCHITECTURE/00_FRAUD_LOGIC.md)
...
*   **Technology Stack:** See [00_TECH_STACK.md](../00_ARCHITECTURE/00_TECH_STACK.md) (Python/Pandas/TheFuzz)
*   **Data Models:** See [00_DATA_MODELS.md](../00_ARCHITECTURE/00_DATA_MODELS.md) (`Evidence`, `ForensicReport`)
*   **Fraud Logic:** See [00_FRAUD_LOGIC.md](../00_ARCHITECTURE/00_FRAUD_LOGIC.md) (Tamper Detection Algorithms)
