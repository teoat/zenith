...
The Simple378 Fraud Detection System is a **cross-platform Electron desktop application** combining the security of local data with the power of modern web technologies. This guide documents the desktop UI, user workflows, and application architecture.
...
#### Data Tab
- **Database Path**: C:\Users\...\Simple378\frauddb.db
...
**Database**: `~/.config/Simple378/frauddb.db`  
...
**Storage**: `~/.config/Simple378/evidence/`  
