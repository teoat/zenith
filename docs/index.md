...
|----------|-----------|------------------|
| **Root** | 3 | Overview, Index, Reference |
| **docs/** | 15+ | API, Architecture, Development, Operations, Standards, Reports |
| **Total** | 18+ | Streamlined documentation |
...
- `SEMANTIC_SEARCH_MIGRATION_GUIDE.md` - Search API migration

### Architecture (`docs/architecture/`)
- `Architecture_Documentation.md` - Comprehensive architecture guide

### Development (`docs/development/`)
- `Developer_Guide.md` - Guides for setup, development, and deployment
- `Planning_Document.md` - Planning, proposals, and validation
- `Implementation_Guide.md` - Implementation tracks, features, and fixes

### Operations (`docs/operations/`)
- All operations-related documents: deployment, monitoring, troubleshooting

### Standards (`docs/standards/`)
- `Standards_and_Compliance_Guide.md` - Standards, policies, and compliance

### Reports (`docs/reports/`)
- `current/Current_Status_Report.md` - Current status and active reports
