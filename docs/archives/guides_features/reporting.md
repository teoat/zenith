...
*   **Data Models:** See [00_DATA_MODELS.md](../00_ARCHITECTURE/00_DATA_MODELS.md)

---

> [!NOTE]
> **Implementation Note:** Features strictly marked as "Court-Admissible" or "Cryptographic" (ISO 27037) are high-complexity items requiring specialized compliance auditing. In the current "Simple378" scope, these will be implemented as standard PDF Reports with hashed logs, which may not meet full legal forensics standards without additional 3rd-party certification.
