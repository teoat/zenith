      ...
      output: {
        manualChunks: (id) => {
          ...
          if (id.includes('node_modules')) {
            ...
            if (id.includes('lucide') || id.includes('radix') || id.includes('class-variance') || id.includes('clsx')) {
              return 'ui-vendor';
            }
            if (id.includes('@tanstack/react-query')) {
              return 'query-vendor';
            }
            if (id.includes('react-force-graph') || id.includes('d3') || id.includes('recharts')) {
              return 'chart-vendor';
            }
