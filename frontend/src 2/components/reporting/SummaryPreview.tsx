...
const SummaryPreview = () => {
  ...
  const findings = [
    { id: '1', type: 'pattern', severity: 'high', description: 'Identified 15 high-risk mirroring patterns involving 3 entities.' },
    { id: '2', type: 'amount', severity: 'high', description: 'Total flagged amount: $4.8M across 47 transactions.' },
    { id: '3', type: 'confirmation', severity: 'medium', description: '3 confirmed fraudulent transactions referred to authorities.' },
    { id: '4', type: 'recommendation', severity: 'medium', description: 'Recommended enhanced monitoring for 2 vendor accounts.' },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6">
            <h3 className="font-bold text-slate-900 dark:text-white mb-4">Transaction Risk Volume</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium text-slate-900 dark:text-white">94% Match</span>
                  </div>
                  <div className="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium text-slate-900 dark:text-white">98 Resolved</span>
                  </div>
                  <div className="w-full bg-slate-100 dark:bg-slate-800 h-1.5 rounded-full overflow-hidden">
