...
interface SystemPerformanceTabProps {
  ...
  currentMetrics: any; // TODO: Fix type compatibility between SystemMetrics and PerformanceMetrics
}

export const SystemPerformanceTab: React.FC<SystemPerformanceTabProps> = ({
  performanceHistory,
}) => {
  return (
    <Card>
