    ...
    <div className={`${styles.container} py-2`}>
      ...
      >
        <div className="flex items-center gap-3">
          {isExpanded ? (
            <ChevronDown
              className={`${styles.icon} text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors`}
            />
          ) : (
            <ChevronRight
              className={`${styles.icon} text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors`}
          ...
          <h3
            className={`${styles.header} text-slate-800 dark:text-white group-hover:text-slate-900 dark:group-hover:text-slate-100 transition-colors`}
          >
            {title}
          </h3>
        </div>
      ...
      >
        <div
          className={`${level > 1 ? "ml-8" : "ml-4"} p-4 bg-slate-50 dark:bg-slate-800/20 rounded-md border border-slate-200 dark:border-slate-700`}
        >
