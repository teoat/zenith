...
const routeConfig: Record<string, { label: string; parent?: string }> = {
  ...
  '/compliance/sar/create': { label: 'Create SAR', parent: '/compliance/monitoring' },
  '/regulatory/intelligence': { label: 'Regulatory Intelligence' },
  '/advanced-compliance': { label: 'Advanced Compliance', parent: '/compliance/monitoring' },
  '/performance': { label: 'Performance' },
  '/diagnostics/system': { label: 'System Diagnostics', parent: '/performance' },
  '/orchestration': { label: 'System Orchestration', parent: '/performance' },
  '/code-review': { label: 'Code Review' },
  '/predictive-maintenance': { label: 'Predictive Maintenance', parent: '/performance' },
  '/ai-lab': { label: 'AI Lab' },
...
function generateBreadcrumbs(pathname: string, caseId?: string): BreadcrumbItem[] {
  ...
  if (caseId && (basePath === '/cases' || basePath === '/investigation' || basePath === '/proof' || basePath === '/dossier')) {
    breadcrumbs.push({
