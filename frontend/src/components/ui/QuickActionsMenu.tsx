...
const quickActions: QuickAction[] = [
  // Core
  {
    ...
    description: "Main alert queue",
    path: "/",
    icon: Gavel,
    category: "core",
    keywords: ["home", "alerts", "adjudication"],
  },
  {
    id: "dashboard",
  ...
  },
  {
    ...
    icon: Briefcase,
    category: "core",
    keywords: ["cases", "investigations", "fraud"],
  },
  {
    id: "ingestion",
    ...
    icon: Database,
    category: "core",
    keywords: ["upload", "import", "data", "evidence"],
  },
  {
    id: "settings",
    label: "Settings",
  ...
  // Investigation
  {
    ...
    keywords: ["forensics", "evidence", "analysis"],
  },
  {
    id: "network",
    ...
    icon: BarChart3,
    category: "investigation",
    keywords: ["network", "graph", "visualization", "connections"],
  },
  {
    id: "graph",
    ...
    icon: Network,
    category: "investigation",
    keywords: ["graph", "relationships", "entities"],
  },
  {
    id: "investigation",
    label: "Investigation Board",
    description: "3D investigation view",
    path: "/investigation",
    icon: Layers,
    category: "investigation",
    keywords: ["investigation", "3d", "board"],
  },
  {
    id: "notebook",
    ...
    icon: BookOpen,
    category: "investigation",
    keywords: ["notes", "notebook", "documentation"],
  },
  {
    id: "reconciliation",
    ...
    icon: GitBranch,
    category: "investigation",
    keywords: ["reconciliation", "matching", "transactions"],
  },
  {
    id: "evidence-enhanced",
    label: "Enhanced Evidence Locker",
    description: "Chain of custody",
    path: "/evidence/enhanced",
    icon: Shield,
    category: "investigation",
    keywords: ["evidence", "custody", "locker"],
  },
  ...
  // Compliance
  {
    ...
    description: "HITL approvals queue",
    path: "/approvals",
    icon: FileCheck,
    category: "compliance",
    keywords: ["approvals", "hitl", "agent"],
  },
  {
    id: "drafts",
    label: "Agent Drafts",
    ...
    icon: Zap,
    category: "compliance",
    keywords: ["drafts", "ai", "recommendations"],
  },
  {
    id: "compliance-monitoring",
    label: "Compliance Monitoring",
    description: "Real-time compliance",
    path: "/compliance/monitoring",
    icon: Activity,
    category: "compliance",
    keywords: ["compliance", "monitoring", "alerts"],
  },
  {
    id: "sar-create",
    label: "Create SAR",
    description: "New SAR filing",
    path: "/compliance/sar/create",
    icon: FileText,
    category: "compliance",
    keywords: ["sar", "filing", "suspicious"],
  },
  {
    id: "regulatory",
    ...
    icon: Bell,
    category: "compliance",
    keywords: ["regulatory", "updates", "intelligence"],
  },
  {
    ...
    icon: Shield,
    category: "compliance",
    keywords: ["advanced", "compliance", "rules"],
  },
  {
    id: "reporting",
    label: "Reporting",
    ...
    icon: TrendingUp,
    category: "compliance",
    keywords: ["reports", "reporting", "analytics"],
  },
  ...
  },
  {
    ...
    icon: Layers,
    category: "system",
    keywords: ["orchestration", "score", "dimensions"],
  },
  {
    id: "predictive",
    ...
    icon: Zap,
    category: "system",
    keywords: ["predictive", "maintenance", "failure"],
  },
  ...
  // AI
  {
    ...
    icon: Beaker,
    category: "ai",
    keywords: ["ai", "lab", "experiments", "ml"],
  },
  {
    id: "code-review",
    label: "Code Review",
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                ...
                <div className="flex items-center gap-4 px-4 py-2 border-t border-slate-200 dark:border-slate-800 text-xs text-slate-500">
                  <span className="flex items-center gap-1">
                    <kbd className="px-1 bg-slate-100 dark:bg-slate-800 rounded">
                      ↑
                    </kbd>
                    <kbd className="px-1 bg-slate-100 dark:bg-slate-800 rounded">
                      ↓
