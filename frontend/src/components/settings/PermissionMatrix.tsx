...
const MOCK_PERMISSIONS: Permission[] = [
  {
    id: "view_cases",
    name: "View Cases",
    description: "Can view case list and details",
    category: "data",
  },
  {
    id: "edit_cases",
    name: "Edit Cases",
    description: "Can modify case details",
    category: "data",
  },
  {
    id: "delete_cases",
  ...
  },
  {
    id: "view_evidence",
    name: "View Evidence",
    description: "Can view evidence files",
    category: "data",
  },
  {
    id: "upload_evidence",
  ...
  },
  {
    id: "manage_users",
    name: "Manage Users",
    description: "Can add/remove users",
    category: "admin",
  },
  {
    id: "manage_settings",
...
const MOCK_ROLES: Role[] = [
  ...
  },
  {
    id: "investigator",
    name: "Investigator",
    description: "Standard case management access",
    permissions: [
      "view_cases",
      "edit_cases",
      "view_evidence",
  ...
  },
  {
    ...
    permissions: ["view_cases", "view_evidence"],
    isSystem: false,
  },
  {
    id: "auditor",
    name: "Auditor",
    description: "Access to audit logs and view-only data",
    permissions: ["view_cases", "view_evidence", "view_audit"],
    isSystem: false,
  },
];
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {!isEditing ? (
            ...
            <>
              <AccessibleButton onClick={cancelEditing} variant="ghost">
                Cancel
              </AccessibleButton>
              <AccessibleButton onClick={saveChanges} variant="primary">
                Save Changes
              </AccessibleButton>
            </>
          )}
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="text-xs uppercase bg-slate-950 text-slate-400 border-b border-slate-800">
              <tr>
                <th className="px-6 py-4 font-bold sticky left-0 bg-slate-950 z-10 w-64 border-r border-slate-800">
                  Permission
                </th>
                <th className="px-6 py-4 font-bold border-r border-slate-800 text-center w-24">
                  Category
                </th>
                {currentRoles.map((role) => (
                  <th
                    key={role.id}
                    className="px-6 py-4 font-bold text-center min-w-[120px]"
                  >
      ...
      {isEditing && (
        <div className="flex items-center gap-2 text-yellow-500 bg-yellow-900/20 p-3 rounded-lg border border-yellow-900/50">
          ...
          <p className="text-xs">
            Caution: Removing permissions from active roles may affect currently
            logged-in users immediately.
          </p>
        </div>
      )}
    </div>
