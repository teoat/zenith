      ...
      <div className="flex h-full max-h-screen flex-col gap-2">
        ...
        <div className="flex-1">
          <nav className="grid items-start px-2 text-sm font-medium lg:px-4 gap-1 mt-4">
            ...
            <NavItem to="/investigation" icon={FileText}>Investigation</NavItem>
            <NavItem to="/agents/drafts" icon={FileText}>Agent Drafts</NavItem>
            <NavItem to="/agents/approvals" icon={ShieldAlert}>Agent Approvals</NavItem>
            <NavItem to="/compliance" icon={ShieldAlert}>Compliance</NavItem>
            <NavItem to="/performance" icon={BarChart3}>Performance</NavItem>
