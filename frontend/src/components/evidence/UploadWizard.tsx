          ...
          {currentStep === "complete" && (
            <div className="text-center">
              ...
              <p className="text-slate-500 mb-8 max-w-sm mx-auto">
                Successfully processed {uploadedFiles.length} files. Hashes have
                been recorded in the chain of custody log.
              </p>
              <AccessibleButton
                onClick={() => {
                  const processedFiles: ProcessedFile[] = uploadedFiles.map(
                    (file) => ({
                      name: file.name,
                      size: file.size,
                      type: file.type,
