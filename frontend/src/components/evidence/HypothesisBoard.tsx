  ...
  const [hypotheses, setHypotheses] = useState<Hypothesis[]>([
    {
      ...
      description:
        "The admin user manually overrode the risk controls to allow the transaction.",
      status: "TESTING",
      supportCount: 2,
      refuteCount: 0,
    },
    {
      ...
      description:
        "The account was accessed via phishing, suggested by external IP address.",
      status: "DISPROVEN",
      supportCount: 1,
      refuteCount: 3,
    },
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Collaborative theory validation and peer review
            </p>
          </div>
          <AccessibleButton
...
const HypothesisCard: React.FC<{ hypothesis: Hypothesis }> = ({
  hypothesis,
}) => {
  return (
