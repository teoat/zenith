...
const AutoReportGenerator: React.FC<AutoReportGeneratorProps> = ({ caseId: _caseId }) => {
    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-6 shadow-sm">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
           <h3 className="text-lg font-bold text-slate-900 dark:text-white">Automated Case Report</h3>
           <p className="text-slate-500 mb-4 text-sm">
             Generate a comprehensive, court-ready investigation summary using AI narrative generation.
           </p>
           ...
           {reportReady ? (
               ...
               <div className="space-y-2 mb-4">
                   <div className="flex items-center gap-2 text-sm text-slate-600">
                       <CheckCircle size={14} className="text-green-500" /> Evidence Analysis
                   </div>
                   <div className="flex items-center gap-2 text-sm text-slate-600">
                       <CheckCircle size={14} className="text-green-500" /> Narrative Construction
                   </div>
                   <div className="flex items-center gap-2 text-sm text-slate-600">
