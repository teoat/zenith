...
const ConclusionWizard: React.FC<ConclusionWizardProps> = ({
  caseId: _caseId,
  onComplete,
}) => {
      ...
      <div className="flex-1 overflow-y-auto p-8">
        {currentStep === 1 && (
          <div className="space-y-6 animate-in fade-in">
            ...
            <p className="text-slate-500">
              Provide a brief overview of the investigation and outcome.
            </p>
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-in fade-in">
            ...
            <p className="text-slate-500">
              Document the evidence and conclusions.
            </p>
            <textarea
            ...
            <div>
              ...
              >
                ...
                <option value="close_confirmed">
                  Close as Confirmed Fraud
                </option>
                <option value="close_false_positive">
            ...
            <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 space-y-4 border border-slate-200 dark:border-slate-700">
              <div>
                ...
                <p className="text-slate-700 dark:text-slate-200">
                  {formData.summary || (
                    <i className="text-slate-400">Not provided</i>
                  )}
                </p>
              </div>
              <div>
        ...
        {currentStep === 4 && (
          <div className="text-center space-y-6 animate-in fade-in pt-12">
            ...
            <p className="text-slate-500">
              Click submit to finalize this case conclusion. This action cannot
              be undone.
            </p>
          </div>
        )}
