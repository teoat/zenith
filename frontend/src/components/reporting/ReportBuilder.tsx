  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 min-h-[600px] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-64 border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 p-4">
        <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wide mb-4 px-2">
          Builder Tools
        </h3>
        ...
        <nav className="space-y-2">
          ...
          >
            <div
              className={`p-1.5 rounded-md ${isConcluded ? "bg-green-100 text-green-600" : "bg-slate-200 text-slate-500"}`}
            >
          ...
          <div className="p-8 h-full">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-slate-500 mb-8">
                Generate a court-admissible dossier package including all
                evidence and chain of custody logs.
              </p>
