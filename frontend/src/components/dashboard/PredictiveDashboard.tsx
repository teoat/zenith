...
const PredictiveDashboard: React.FC = () => {
    ...
    if (loading) return <div className="p-8 text-center animate-pulse">Loading Predictive Intelligence...</div>;
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <button onClick={loadData} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full">
                    <RefreshCw size={16} />
                </button>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm h-64">
                <h3 className="text-sm font-semibold mb-4 text-slate-700 dark:text-slate-300">7-Day Risk Forecast</h3>
