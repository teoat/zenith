...
const CaseProgressBar: React.FC<CaseProgressBarProps> = ({
  ...
  const stages: ProgressStage[] = [
    ...
    },
    {
      ...
      status: progress >= 30 ? 'completed' : progress >= 10 ? 'current' : 'pending',
      description: 'Documents and data gathered'
    },
    {
      id: 'analysis',
      label: 'Initial Analysis',
      status: progress >= 60 ? 'completed' : progress >= 30 ? 'current' : 'pending',
      description: 'Pattern recognition and anomaly detection'
    },
    {
      id: 'investigation',
      label: 'Deep Investigation',
      status: progress >= 80 ? 'completed' : progress >= 60 ? 'current' : 'pending',
      description: 'Detailed forensic examination'
    },
    {
      id: 'closure',
      label: 'Case Closure',
      status: progress >= 100 ? 'completed' : progress >= 80 ? 'current' : 'pending',
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className={`font-medium ${
                      ...
                      stage.status === 'current' ? 'text-blue-700 dark:text-blue-400' :
