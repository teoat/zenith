...
import { Rule, RuleParameters, NewRule } from '@/types/fraud';
  ...
  return (
    <div className="p-6 bg-white dark:bg-slate-900 rounded-lg">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Fraud Detection Rules</h2>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${getRiskLevelColor(rule.risk_level)}`}>
                    {rule.risk_level}
                  </span>
                </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl max-w-2xl w-full p-6">
            <h3 className="text-xl font-bold mb-4 text-slate-900 dark:text-white">Create New Rule</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  <option value="velocity">Velocity (Transaction Frequency)</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewRule({ ...newRule, risk_level: e.target.value as Rule['risk_level'] })}
                  className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800"
                >
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewRule({
                        ...newRule,
                        parameters: { ...newRule.parameters, max_transactions: parseInt(e.target.value) }
                      })}
                      className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setNewRule({
                        ...newRule,
                        parameters: { ...newRule.parameters, time_window_minutes: parseInt(e.target.value) }
                      })}
                      className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800"
                    />
                  </div>
              ...
              {newRule.rule_type === 'amount' && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewRule({
                      ...newRule,
                      parameters: { ...newRule.parameters, threshold_amount: parseFloat(e.target.value) }
                    })}
                    className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800"
                  />
                </div>
