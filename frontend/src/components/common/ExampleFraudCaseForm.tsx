...
export const ExampleFraudCaseForm: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto bg-white rounded-xl shadow-md space-y-4 border border-slate-200">
      <h2 className="text-2xl font-bold text-slate-900">Create New Fraud Case</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          />
          {errors.caseTitle && <span className="text-red-500 text-xs">{errors.caseTitle.message}</span>}
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700">Occurrence Date</label>
          <input
            type="date"
