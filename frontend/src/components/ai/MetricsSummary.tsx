...
import { FileText, AlertTriangle, Clock, TrendingUp, Shield, Zap } from 'lucide-react';
...
export const MetricsSummary: React.FC<MetricsSummaryProps> = ({ reviewResult }) => {
  return (
    <div className="bg-white rounded-lg shadow-sm border p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Quality Overview</h3>
        <div className={`px-3 py-1 rounded-full text-sm font-medium ${getRatingColor(reviewResult.quality_rating)}`}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="text-center">
          <div className="text-2xl font-bold text-gray-900">{reviewResult.quality_score.toFixed(1)}</div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <div className="font-semibold">{reviewResult.metrics.total_issues}</div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <div className="font-semibold">{reviewResult.metrics.analysis_time_seconds.toFixed(1)}s</div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <div className="font-semibold">{reviewResult.metrics.security_issues}</div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <div className="font-semibold">{reviewResult.metrics.performance_issues}</div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <div className="font-semibold">{reviewResult.metrics.maintainability_issues}</div>
