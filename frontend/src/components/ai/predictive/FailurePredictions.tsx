...
export const FailurePredictions: React.FC<FailurePredictionsProps> = ({
  predictions,
}) => {
    ...
    >
      <div className="predictions-section">
        ...
        <p className="section-description">
          Predicted system failures based on current metrics and historical
          patterns.
        </p>
            ...
            <div key={index} className="prediction-card">
              <div className="prediction-header">
                ...
                <div className="prediction-probability">
                  <span
                    className={`probability-value ${getProbabilityColor(prediction.probability)}`}
                  >
              ...
              <div className="prediction-details">
                <div className="prediction-metrics">
                  <div className="metric">
                    ...
                    <span className="metric-value">
                      {prediction.time_to_failure_hours.toFixed(1)} hours
                    </span>
                  </div>
                  <div className="metric">
                ...
                <div className="prediction-factors">
                  ...
                  <ul className="factors-list">
                    {prediction.contributing_factors.map(
                      (factor, factorIndex) => (
                        <li key={factorIndex} className="factor-item">
                          {factor}
                        </li>
                      ),
                    )}
