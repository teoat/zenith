...
interface CaseListProps {
  ...
  onToggleSelection: (id: string, e?: React.MouseEvent | React.KeyboardEvent) => void;
  onSelectAll: () => void;
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-start mb-1">
                  <p className={`font-bold transition-colors truncate pr-2 ${isPreviewing ? 'text-blue-600 dark:text-blue-400' : 'text-slate-900 dark:text-white'}`}>
                    {caseItem.title}
                  </p>
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-[10px] font-bold text-slate-500 italic">Risk {caseItem.riskScore || 0}%</span>
                </div>
