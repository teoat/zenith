...
export const AutoReportGenerator: React.FC<AutoReportGeneratorProps> = ({
  ...
  const generateSection = useCallback(
    async (sectionType: string): Promise<string> => {
      // Simulate AI generation delay
      await new Promise((resolve) =>
        setTimeout(resolve, 1000 + secureRandom.random() * 1500),
      );
      ...
      return (
        mockContent[sectionType] ||
        `Generated content for ${sectionType} section. This section analyzes relevant aspects of the investigation and provides detailed findings based on the available evidence.`
      );
    },
    [defaultCaseData],
  );
  ...
  const handleGenerate = useCallback(async () => {
    ...
    for (let i = 0; i < sectionsToGenerate.length; i++) {
      ...
      try {
        ...
        setSections((prev) =>
          prev.map((s) => (s.id === sectionType ? section : s)),
        );
      } catch {
        setSections((prev) =>
          prev.map((s) =>
                    ...
                    return (
                      <div key={id} className="section-checkbox">
                        ...
                        <Label htmlFor={id} className="section-checkbox-label">
                          ...
                          <span className="word-estimate">
                            ~{config.estimatedWords} words
                          </span>
                        </Label>
                      </div>
                    );
              ...
              <div className="case-summary">
                ...
                <div className="summary-grid">
                  ...
                  <div className="summary-item">
                    ...
                    <span>
                      ${defaultCaseData.transactionTotal.toLocaleString()}
                    </span>
                  </div>
                  <div className="summary-item">
            ...
            <ScrollArea className="report-preview">
              <div className="preview-header">
                ...
                <p className="preview-subtitle">
                  Case ID: {defaultCaseData.caseId}
                </p>
              ...
              <div className="export-format-grid">
                {["pdf", "docx", "html"].map((format) => (
                  <Button
                    ...
                    onClick={() =>
                      onExport?.(format as "pdf" | "docx" | "html")
                    }
                  >
