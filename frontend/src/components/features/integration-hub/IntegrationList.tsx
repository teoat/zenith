...
import { Search, Filter, CheckCircle, Clock, AlertCircle, Settings, Webhook, Globe, Zap, Database, ExternalLink, Server } from 'lucide-react';
...
export const IntegrationList: React.FC<IntegrationListProps> = ({ integrations }) => {
