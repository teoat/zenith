...
const AdjudicationLayout: React.FC<AdjudicationLayoutProps> = ({ list, detail, isDetailOpen }) => {
  return (
      ...
      `}>
        {isDetailOpen ? detail : (
          <div className="h-full flex flex-col items-center justify-center text-slate-400 p-8 text-center">
             ...
             <h3 className="text-lg font-medium text-slate-900 dark:text-white mb-2">Select an alert to review</h3>
             <p className="max-w-sm">Use arrow keys ↑ ↓ to navigate quickly. Press 'A' to approve or 'R' to reject.</p>
          </div>
        )}
      </div>
    </div>
