      ...
      const mockAlerts: RegulatoryAlert[] = [
        {
          ...
          description:
            "FATF has issued updated guidance for virtual asset service providers regarding customer due diligence and record keeping requirements.",
          source: "FATF",
          severity: "high",
          category: "AML/CFT",
        ...
        },
        {
          ...
          description:
            "Office of Foreign Assets Control has added 15 new Specially Designated Nationals to the sanctions list.",
          source: "OFAC",
          severity: "critical",
          category: "Sanctions",
        ...
        },
        {
          ...
          description:
            "European Parliament has approved comprehensive digital finance legislation including crypto-asset regulations.",
      ...
      const mockUpdates: RegulatoryUpdate[] = [
        {
          ...
          summary:
            "The Financial Crimes Enforcement Network has issued a final rule requiring financial institutions to identify and verify beneficial owners of legal entity customers.",
          source: "FINCEN",
        ...
        },
        {
          ...
          summary:
            "Monetary Authority of Singapore has updated its regulatory requirements for financial institutions outsourcing material functions.",
          source: "MAS",
      ...
      const mockFeeds: IntelligenceFeed[] = [
        {
          ...
          content:
            "Intelligence indicates increasing use of non-fungible tokens (NFTs) for money laundering activities, particularly through wash trading and artificial inflation schemes.",
        ...
        },
        {
          ...
          content:
            "Analysis of recent cases shows sophisticated use of decentralized finance protocols to circumvent sanctions through anonymous transactions and privacy coins.",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Real-time regulatory alerts, updates, and intelligence feeds
          </p>
        </div>
              ...
              <CardContent>
                <div className="flex items-center justify-between text-sm text-gray-600">
                  <div className="flex items-center space-x-4">
                    <span>
                      Frameworks: {alert.relevant_frameworks.join(", ")}
                    </span>
          ...
          {updates.map((update) => (
            <Card key={update.id} className="hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <div className="flex items-center justify-between text-sm text-gray-600">
                  <span>
                    Affected Frameworks: {update.frameworks_affected.join(", ")}
                  </span>
                  <div className="flex items-center">
                    <Clock className="h-4 w-4 mr-1" />
