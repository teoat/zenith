  ...
  const handleImportSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (uploadedFiles.length > 0) {
        const result =
          await fileProcessingService.processCaseImportFiles(uploadedFiles);
        ...
        if (result.casesCreated > 0) {
          secureLogger.info(
            `Successfully created ${result.casesCreated} cases from uploaded files`,
          );
        }
      }
      ...
      navigate("/login", {
        replace: true,
        state: { message: "Setup complete. Please log in." },
      });
    } catch (err: unknown) {
  ...
  const roleOptions = [
    {
      ...
      title: "Fraud Analyst",
      description:
        "Review alerts, analyze patterns, and support investigations",
      icon: "🔍",
    },
    {
      ...
      description:
        "Lead complex cases, manage evidence, and coordinate responses",
      icon: "🕵️",
    },
    {
      ...
      title: "Administrator",
      description:
        "Configure system settings, manage users, and oversee operations",
      icon: "⚙️",
    },
  ];
          ...
          {step === "import" && (
            ...
            >
              ...
              <div>
                ...
                />
                <p className="mt-2 text-xs text-gray-500">
                  Drag and drop case files here, or click to browse. Supported:
              ...
              <div className="flex space-x-3">
                ...
                >
                  {uploadedFiles.length > 0
                    ? `Import ${uploadedFiles.length} Files & Complete`
                    : "Skip Import & Complete"}
                </AccessibleButton>
              </div>
            </form>
          )}
