...
const SummaryPreview = React.lazy(
  () => import("../components/reporting/SummaryPreview"),
);
const FinancialHealth = React.lazy(
  () => import("../components/reporting/FinancialHealth"),
);
const ProjectTracker = React.lazy(
  () => import("../components/reporting/ProjectTracker"),
);

const Reporting = () => {
  const [activeTab, setActiveTab] = useState<
    "summary" | "financial" | "project" | "builder"
  >("summary");
