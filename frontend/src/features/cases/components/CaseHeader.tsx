    ...
    <div className="flex-shrink-0 p-6 flex justify-between items-center bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
          ...
          Cases
          <span className="bg-slate-100 dark:bg-slate-800 text-slate-500 text-xs px-2 py-0.5 rounded-full font-normal">
            {caseCount}
          </span>
        </h1>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden xl:flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg border border-slate-200 dark:border-slate-700 h-9 mr-2">
          <span className="text-[10px] font-medium px-2 text-slate-500 uppercase tracking-wider">
            Macros
          </span>
          <button
            className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 rounded transition-colors"
            title="Reject & Block Entity"
          >
            <Zap size={12} className="fill-current" />
            Reject
          </button>
          <button
            className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 rounded transition-colors"
