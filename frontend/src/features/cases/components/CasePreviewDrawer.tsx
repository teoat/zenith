...
const CasePreviewDrawer: React.FC<CasePreviewDrawerProps> = ({
  caseId,
  isOpen,
  onClose,
  isEmbedded = false,
  ...
  const caseData = caseId
    ? {
        ...
        amount: "$45,200",
        description:
          "Multiple deposits under $10,000 threshold within 48 hours.",
      }
    : null;
            ...
            <div className="flex flex-col h-full">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-slate-500 text-sm">Case Details</p>
                </div>
              </div>
