...
const ThreatMap = React.lazy(
  () => import(/* webpackChunkName: "threat-map" */ "./ThreatMap"),
);
const AIWatchtower = React.lazy(
  () => import(/* webpackChunkName: "ai-watchtower" */ "./AIWatchtower"),
);
const LiveQueue = React.lazy(
  () => import(/* webpackChunkName: "live-queue" */ "./LiveQueue"),
);
const VolumeChart = React.lazy(
  () => import(/* webpackChunkName: "volume-chart" */ "./VolumeChart"),
);
const RiskDistributionChart = React.lazy(
  () => import(/* webpackChunkName: "risk-chart" */ "./RiskDistributionChart"),
);
const ProofVisualizationCard = React.lazy(
  () => import(/* webpackChunkName: "proof-viz" */ "./ProofVisualizationCard"),
);
const CostOptimizationWidget = React.lazy(
  () =>
    import(/* webpackChunkName: "cost-widget" */ "./CostOptimizationWidget"),
);
...
const KPICard = ({
  ...
  <div
    className={`h-full p-4 rounded-xl border shadow-sm flex flex-col justify-between ${
      isCritical
  ...
  >
    <div className="flex justify-between items-start">
      <div
        className={`p-2 rounded-lg ${isCritical ? "bg-red-100 dark:bg-red-900/20" : "bg-slate-100 dark:bg-slate-800"}`}
      >
        {icon}
      </div>
      {trend && (
        <span
          className={`text-xs font-medium px-2 py-0.5 rounded-full ${isCritical ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`}
        >
          {trend}
        </span>
      )}
...
const WidgetWrapper = ({
  ...
  <div
    className={`bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm h-full overflow-hidden flex flex-col ${className}`}
  >
    {title && (
            ...
            >
              <RiskDistributionChart
                data={[
                  {
                    name: "Critical",
                    value: metrics?.riskDistribution?.critical || 0,
                    color: "#ef4444",
                  },
                  {
                    name: "High",
