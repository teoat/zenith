...
// NOTE: This file represents the legacy manual type definitions.
// A NEW Auto-Generated SSOT (Single Source of Truth) schema is available at:
// src/types/openapi.d.ts
//
// Future work should focus on migrating these interfaces to `import { components } from './openapi.d.ts'`
