...
export type ChangeEventHandler<TElement = HTMLElement> = (event: React.ChangeEvent<TElement>) => void;
export type FormEventHandler<TElement = HTMLFormElement> = (event: React.FormEvent<TElement>) => void;
export type FocusEventHandler<TElement = HTMLElement> = (event: React.FocusEvent<TElement>) => void;
export type KeyboardEventHandler<TElement = HTMLElement> = (event: React.KeyboardEvent<TElement>) => void;
export type MouseEventHandler<TElement = HTMLElement> = (event: React.MouseEvent<TElement>) => void;
export type TouchEventHandler<TElement = HTMLElement> = (event: React.TouchEvent<TElement>) => void;
...
// Keyboard handlers
export type KeyDownHandler<TElement = HTMLElement> = KeyboardEventHandler<TElement>;
export type KeyUpHandler<TElement = HTMLElement> = KeyboardEventHandler<TElement>;
export type KeyPressHandler<TElement = HTMLElement> = KeyboardEventHandler<TElement>;
...
export type EventValue<TEvent> = TEvent extends React.ChangeEvent<infer TElement>
  ? TElement extends HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement
    ? TElement['value']
    : unknown
  : unknown;

export type EventTarget<TEvent> = TEvent extends { currentTarget: infer TTarget }
  ? TTarget
  : unknown;

// Event handler factories
export const createChangeHandler = <TValue = unknown>(
  onChange: (value: TValue) => void
...
export const withStopPropagation = <TEvent extends Event>(
  handler: EventHandler<TEvent>
) => (event: TEvent) => {
