...
export const AccessibilityProvider: React.FC<AccessibilityProviderProps> = ({
  ...
  const [reducedMotion, setReducedMotion] = useState(() => {
    return (
      localStorage.getItem("accessibility-reducedMotion") === "true" ||
  ...
  const [fontSize, setFontSize] = useState<"small" | "medium" | "large">(() => {
    return (
      (localStorage.getItem("accessibility-fontSize") as
        | "small"
        | "medium"
        | "large") || "medium"
    );
  ...
  >(() => {
    return (
      (localStorage.getItem("accessibility-colorBlindMode") as
        | "none"
        | "protanopia"
        | "deuteranopia"
        | "tritanopia") || "none"
