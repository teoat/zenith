...
export const reconciliationService = {
  ...
  analyzeCashFloat: async (
    entityName: string,
    startDate: Date,
    endDate: Date,
  ): Promise<CashFloatAnalysisResult> => {
  ...
  analyzeSequenceAnomalies: async (
    transactionIds: string[],
