...
export const reportingService = {
  ...
  createScheduledReport: async (requestBody: ScheduledReportRequest): Promise<ScheduledReport> => {
    return request('/reporting/scheduled', {
      method: 'POST',
  ...
  generateAISummary: async (caseId: string, prompt?: string): Promise<{ summary: string }> => {
