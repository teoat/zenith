      ...
      try {
        ...
        const aiIssues: CodeIssue[] = aiData.issues.map((issue: AIIssue) => {
          ...
          return {
            ...
            cwe_id:
              issue.cwe_id ||
              (issue.issue_type === "sql_injection_risk"
                ? "CWE-89"
        ...
        const realResult: CodeReviewResult = {
          ...
          quality_rating:
            (aiData.quality_score || 0) > 80
              ? "good"
              : (aiData.quality_score || 0) > 60
                ? "fair"
                : "poor",
          issues: aiIssues,
          metrics: {
            total_issues: aiIssues.length,
            issues_by_category: aiIssues.reduce(
              (acc, issue) => {
            ...
            issues_by_severity: aiIssues.reduce(
              (acc, issue) => {
            ...
            issues_per_1000_lines:
              (aiIssues.length / sampleCode.split("\n").length) * 1000,
        ...
        secureLogger.warn(
          "Real AI Analysis failed, falling back to simulation:",
          error,
        );
        ...
        const mockResult: CodeReviewResult = {
          ...
          issues: [
            ...
            },
            {
              ...
              description:
                "Console statements should be removed for production builds",
              code_snippet:
                "00087:   const handleSubmit = (data) => {\n00088:     secureLogger.info('Form submitted:', data);\n00089:     // Process form data\n00090:   };",
