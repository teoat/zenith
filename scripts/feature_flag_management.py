...
class FeatureFlagManager:
    ...
    def update_flag(self, name: str, **updates) -> FeatureFlag | None:
    ...
    def is_enabled(
        self, flag_name: str, user_context: dict[str, Any] | None = None
    ) -> bool:
    ...
    def list_flags(self, tag_filter: str | None = None) -> list[dict[str, Any]]:
    ...
    def disable_flag(self, name: str) -> bool:
        ...
        return (
            self.update_flag(
                name, state=FeatureFlagState.DISABLED, rollout_percentage=0.0
            )
            is not None
        )
...
def is_feature_enabled(
    feature_name: str, user_context: dict[str, Any] | None = None
) -> bool:
...
def update_feature_flag(name: str, **updates) -> FeatureFlag | None:
...
def list_feature_flags(tag_filter: str | None = None) -> list[dict[str, Any]]:
    """List feature flags"""
