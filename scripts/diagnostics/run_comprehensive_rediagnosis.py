...
def print_risk_assessment(risks: dict):
    ...
    print_metric("Total Mitigation Cost", risk_summary.get('total_mitigation_cost', 0), " USD")
...
async def main():
    ...
    try:
        ...
        areas_to_analyze = [
            ...
            ('Performance Characteristics', diagnosis.get('performance_characteristics', {})),
        ...
        if roadmap:
            ...
            for timeframe, details in roadmap.items():
                ...
                print(f"   Benefits: {details.get('expected_benefits', 'Not specified')}")

        # Save comprehensive results
        output_file = f"comprehensive_rediagnosis_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
